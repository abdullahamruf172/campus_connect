			...
			<div class="l-part">
				<form action="" method="post">
					...
					<div class="overlap-text">
						...
						<a style="text-decoration:none;float: right;color: #337AFF;" data-toggle="tooltip" title="Reset Password" href="forgot_password.php">Forgot?</a>
					</div>
					<a style="text-decoration: none;float: right;color: #337AFF;" data-toggle="tooltip" title="Create Account!" href="signup.php">Don't have an account?</a><br><br>
